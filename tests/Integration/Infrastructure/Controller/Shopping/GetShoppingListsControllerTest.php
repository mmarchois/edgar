...
final class GetShoppingListsControllerTest extends AbstractWebTestCase
{
    public function testMathieuList(): void
    {
        ...
        $this->assertSame('http://localhost/0b507871-8b5e-4575-b297-a630310fc06e', $shoppingLinks->eq(0)->link()->getUri());
        $this->assertSame('http://localhost/save/0b507871-8b5e-4575-b297-a630310fc06e', $editLinks->eq(0)->link()->getUri());

        $this->assertSame('Leclerc Aix', $item->eq(1)->filter('h4')->text());
        $this->assertSame('http://localhost/8c6c9813-3b58-4cb7-9056-5c432c230446', $shoppingLinks->eq(1)->link()->getUri());
        $this->assertSame('http://localhost/save/8c6c9813-3b58-4cb7-9056-5c432c230446', $editLinks->eq(1)->link()->getUri());
    }
    ...
    public function testHeleneList(): void
    {
        ...
        $this->assertSame('http://localhost/e999a808-21ee-4533-8e05-a7bdd82d5934', $shoppingLinks->eq(2)->link()->getUri());
        $this->assertSame('http://localhost/save/e999a808-21ee-4533-8e05-a7bdd82d5934', $editLinks->eq(2)->link()->getUri());
    }
